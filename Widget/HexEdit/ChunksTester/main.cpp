...
int main()
{
    ...
    TestChunks tc(sumLog, "overwrite", 0x4000, true, 0x7fffffff);
    ...
    TestChunks tc2(sumLog, "insert", 0x4000, true, 0x7fffffff);
    tc2.insert(0, 'E');        // 0
    tc2.insert(0x50, 'x');     // 1
    ...
    TestChunks tc3(sumLog, "remove", 0x4000, true, 0x7fffffff);
    tc3.removeAt(0);           // 0
    tc3.removeAt(0x50);        // f
    ...
    TestChunks tc4(sumLog, "random", 0x40000, true, 0x7fffffff);
    tc4.random(1000);
